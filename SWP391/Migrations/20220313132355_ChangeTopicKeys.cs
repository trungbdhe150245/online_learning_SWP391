    ...
    public partial class ChangeTopicKeys : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CourseId = table.Column<string>(type: "varchar(10)", nullable: false),
                    PurchaseTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseOwners", x => new { x.CourseOwnerId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoURL = table.Column<string>(type: "text", nullable: true),
                    TopicId = table.Column<string>(type: "varchar(10)", nullable: true)
                },
                constraints: table =>
                {
